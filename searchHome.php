...
if(isset($_POST['Firstname'])){
    ...
    while($row = $result1->fetch_assoc()) {
        echo "<tr><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Prod_brand"]."</a></td><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Product_descri"]."</a></td><td>".$row["Model"]."</td><td>".$row["Product_price"]."</td><td>". $dbname1."</td></tr>";
    }}
        
	while($row = mysqli_fetch_array($result2)){
    while($row = $result2->fetch_assoc()) {
       echo "<tr><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Prod_brand"]."</a></td><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Product_descri"]."</a></td><td>".$row["Model"]."</td><td>".$row["Product_price"]."</td><td>".$dbname2."</td></tr>";
    }}
        
	while($row = mysqli_fetch_array($result3)){
    while($row = $result3->fetch_assoc()) {
        echo "<tr><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Prod_brand"]."</a></td><td><a href= viewing.php?ID=".$row["Product_id"].">".$row["Product_descri"]."</a></td><td>".$row["Model"]."</td><td>".$row["Product_price"]."</td><td>".$dbname3."</td></tr>";
    }}
